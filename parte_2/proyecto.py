...
#Partes de Pruebas que no se tocan por el oversampler osease son reales
...
for x_train,y_train,x_test,y_test in zip(X_train_binarizada_v,y_train_polaridad_binarizada_v,X_test_binarizada_v,y_test_polaridad_binarizada_v):
    ...
    precision, recall, F_Measure, support = score(y_test, prediccion)
...
for x_train,y_train,x_test,y_test in zip(X_train_atraccion_binarizada_v,y_train_atraccion_binarizada_v,X_test_atraccion_binarizada_v,y_test_atraccion_binarizada_v):
    ...
    # xd=classification_report(prediccion,y_test)
    # print(xd)
...
if best_model_representation_Polarity[0][1] == 'Binarizada':
    ...
    accuracy=accuracy_score(y_test_polaridad_binario, Test_results)
    precision, recall, F_Measure, support = score(y_test_polaridad_binario, Test_results)
    recall = median(recall)
    F_Measure = median(F_Measure)
    precision = median(precision)
    ...
    accuracy=accuracy_score(X_test_polaridad_frecuencia, Test_results)
    precision, recall, F_Measure, support = score(X_test_polaridad_frecuencia, Test_results)
    recall = median(recall)
    F_Measure = median(F_Measure)
    precision = median(precision)
...
if best_model_representation_Atraction[0][1] == 'Binarizada':
    ...
    accuracy=accuracy_score(y_test_atraccion_binario, Test_results)
    precision, recall, F_Measure, support = score(y_test_atraccion_binario, Test_results)
    recall = median(recall)
    F_Measure = median(F_Measure)
    precision = median(precision)
    ...
    accuracy=accuracy_score(y_test_atraccion_frecuencia, Test_results)
    precision, recall, F_Measure, support = score(y_test_atraccion_frecuencia, Test_results)
    recall = median(recall)
    F_Measure = median(F_Measure)
    precision = median(precision)
